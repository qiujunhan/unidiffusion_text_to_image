...
#     roop_args = program.parse_known_args()#.parse_args()
...
class get_arg():
    def __init__(self,):
        ...
        self.frame_processor = ['face_swapper']
        self.keep_fps = True
        self.keep_frames = True

        
        self.skip_audio = True
        self.many_faces = True
        self.skip_audio = True
        self.many_faces = True
        self.reference_face_position = 0
        self.reference_frame_number = 0
        self.similar_face_distance = 0.85
        self.temp_frame_format = 'png'
        self.temp_frame_quality = 0
        self.output_video_encoder = 'libx264'
        self.output_video_quality = 'libx264'

        
        self.max_memory = None
        self.execution_provider = ['cpu']
        self.execution_threads = suggest_execution_threads()
...
def run(ssource_path,starget_path,soutput_path):
    roop_args = get_arg()

    roop_args.source_path = ssource_path
    roop_args.target_path = starget_path
    roop_args.output_path = soutput_path


    
    global_args(roop_args)
