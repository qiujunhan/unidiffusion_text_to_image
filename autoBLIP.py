...
for file in tqdm(glob("processed_train_data/boy1/*.png")):
    # file = "processed_train_data/boy1/00000-0-00000-0-0.png"
    output_file = file.replace(".png",".txt")
    img = Image.open(file)
    ...
    for i in range(20):
        caption = blip_model.generate(gpu_image, sample=False, num_beams=10, min_length=24, max_length=48)
        print(caption[0])
        f.write(caption[0]+"\n")
